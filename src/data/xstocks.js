...
export const TOKENS = {
  ...
  ANTHROPIC: { name: "Anthropic PreStocks", sector: "Artificial Intelligence", mint: "Pren1FvFX6J3E4kXhJuCiAD5aDmGEb7qJRncwA8Lkhw", price: 1052.74, liq: 872094, venue: "Jupiter", domain: "anthropic.com", decimals: 9, group: "Pre-IPO", issuer: "PreStocks", psId: "anthropic" },
  OPENAI: { name: "OpenAI PreStocks", sector: "Artificial Intelligence", mint: "PreweJYECqtQwBtpxHL171nL2K6umo692gTm7Q3rpgF", price: 1335.23, liq: 826650, venue: "Jupiter", domain: "openai.com", decimals: 9, group: "Pre-IPO", issuer: "PreStocks", psId: "openai" },
  SPACEX: { name: "SpaceX PreStocks", sector: "Aerospace", mint: "PreANxuXjsy2pvisWWMNB6YaJNzr7681wJJr2rHsfTh", price: 117.47, liq: 111319, venue: "Jupiter", domain: "spacex.com", decimals: 9, group: "Pre-IPO", issuer: "PreStocks", psId: "spacex" },
  ANDURIL: { name: "Anduril PreStocks", sector: "Defense", mint: "PresTj4Yc2bAR197Er7wz4UUKSfqt6FryBEdAriBoQB", price: 164.95, liq: 451666, venue: "Jupiter", domain: "anduril.com", decimals: 9, group: "Pre-IPO", issuer: "PreStocks", psId: "anduril" },
  FIGUREAI: { name: "Figure AI PreStocks", sector: "Robotics", mint: "PreZad18qfPtbxNpMtMuAuX2zVpvkEU8DnJx56faCWd", price: 176.72, liq: 100761, venue: "Jupiter", domain: "figure.ai", decimals: 9, group: "Pre-IPO", issuer: "PreStocks", psId: "figureai" },
  NEURALINK: { name: "Neuralink PreStocks", sector: "Neurotech", mint: "PrekqLJvJ3qVdXmBGDiexvwUTF4rLFDa6HWS4HJbw9S", price: 446.64, liq: 245762, venue: "Jupiter", domain: "neuralink.com", decimals: 9, group: "Pre-IPO", issuer: "PreStocks", psId: "neuralink" },
  KALSHI: { name: "Kalshi PreStocks", sector: "Prediction Markets", mint: "PreLWGkkeqG1s4HEfFZSy9moCrJ7btsHuUtfcCeoRua", price: 881.50, liq: 99666, venue: "Jupiter", domain: "kalshi.com", decimals: 9, group: "Pre-IPO", issuer: "PreStocks", psId: "kalshi" },
  POLYMARKET: { name: "Polymarket PreStocks", sector: "Prediction Markets", mint: "Pre8AREmFPtoJFT8mQSXQLh56cwJmM7CFDRuoGBZiUP", price: 152.52, liq: 198618, venue: "Jupiter", domain: "polymarket.com", decimals: 9, group: "Pre-IPO", issuer: "PreStocks", psId: "polymarket" },
};
...
export const BASKETS = [
  ...
  { id: "prestocks", name: "PreStocks Frontier", theme: "Pre-IPO",   thesis: "The frontier-tech private companies as PreStocks tokens: Anthropic, OpenAI, SpaceX, Anduril and Figure AI. Volatile, thinly traded, high risk.", legs: [["ANTHROPIC", 30], ["OPENAI", 25], ["SPACEX", 20], ["ANDURIL", 15], ["FIGUREAI", 10]] },
